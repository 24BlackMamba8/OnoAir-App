...
export class FlightService {
  ...
  private flights: Flight[] = [
    ...
    { id: 11, flightNumber: 'QF101', origin: 'Sydney', destination: 'Los Angeles', departure: new Date('2024-05-01T07:00:00'), arrival: new Date('2024-05-01T20:30:00'), seats: 290, image: 'src/assets/images/los-angeles.jpg' },
    { id: 12, flightNumber: 'TK987', origin: 'Istanbul', destination: 'Berlin', departure: new Date('2024-05-05T12:45:00'), arrival: new Date('2024-05-05T16:20:00'), seats: 175, image: 'src/assets/images/berlin.jpg' },
    { id: 13, flightNumber: 'AC345', origin: 'Toronto', destination: 'Vancouver', departure: new Date('2024-05-10T14:00:00'), arrival: new Date('2024-05-10T17:15:00'), seats: 190, image: 'src/assets/images/vancouver.jpg' },
    { id: 14, flightNumber: 'JL567', origin: 'Tokyo', destination: 'Bangkok', departure: new Date('2024-05-15T09:30:00'), arrival: new Date('2024-05-15T14:00:00'), seats: 230, image: 'src/assets/images/bangkok.jpg' },
    { id: 15, flightNumber: 'NZ345', origin: 'Auckland', destination: 'Fiji', departure: new Date('2024-05-20T11:00:00'), arrival: new Date('2024-05-20T14:30:00'), seats: 160, image: 'src/assets/images/fiji.jpg' },
    { id: 16, flightNumber: 'BA432', origin: 'London', destination: 'Rome', departure: new Date('2024-05-25T08:15:00'), arrival: new Date('2024-05-25T11:30:00'), seats: 220, image: 'src/assets/images/rome.jpg' },
    { id: 17, flightNumber: 'AF789', origin: 'Paris', destination: 'Moscow', departure: new Date('2024-05-30T13:00:00'), arrival: new Date('2024-05-30T18:45:00'), seats: 180, image: 'src/assets/images/moscow.jpg' },
    { id: 18, flightNumber: 'LH999', origin: 'Frankfurt', destination: 'Vienna', departure: new Date('2024-06-04T10:30:00'), arrival: new Date('2024-06-04T12:15:00'), seats: 150, image: 'src/assets/images/vienna.jpg' },
    { id: 19, flightNumber: 'EK550', origin: 'Dubai', destination: 'Johannesburg', departure: new Date('2024-06-10T21:00:00'), arrival: new Date('2024-06-11T05:30:00'), seats: 300, image: 'src/assets/images/johannesburg.jpg' },
    { id: 20, flightNumber: 'CX888', origin: 'Hong Kong', destination: 'Seoul', departure: new Date('2024-06-15T16:45:00'), arrival: new Date('2024-06-15T21:10:00'), seats: 200, image: 'src/assets/images/seoul.jpg' }
  ];
